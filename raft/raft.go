...
const (
	// ElectionTimeoutTick ElectionTick is the number of Node.Tick invocations that must pass between
...
// RaftState 增加Raft的state Add: tantexian, <my.oschina.net/tantexian> Since: 2017/3/28
type RaftState int
